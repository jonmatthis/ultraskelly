...
from ultraskelly.core.pipeline.processing_pipeline import BasePipelineConfig, PipelineImageAnnotator, \
    BaseProcessingPipeline
from ultraskelly.core.tasks.mocap_task.mocap_aggregation_node import MocapAggregationNodeConfig, \
    MocapPipelineOutputData, MocapAggregationProcessNode
from ultraskelly.core.tasks.mocap_task.mocap_camera_node import MocapPipelineCameraNodeConfig, MocapCameraNode
