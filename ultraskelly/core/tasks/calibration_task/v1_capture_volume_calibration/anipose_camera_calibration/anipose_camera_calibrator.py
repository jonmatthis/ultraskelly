...
import cv2
import numpy as np
from ultraskelly.core_processes.capture_volume_calibration.anipose_camera_calibration import (
    ultraskelly_anipose,
)
from ultraskelly.core_processes.capture_volume_calibration.anipose_camera_calibration.charuco_groundplane_utils import (
...
from ultraskelly.core_processes.capture_volume_calibration.charuco_stuff.charuco_board_definition import (
    CharucoBoardDefinition,
)
from ultraskelly.system.paths_and_filenames.path_getters import (
    create_camera_calibration_file_name,
    get_calibrations_folder_path,
    get_last_successful_calibration_toml_path,
)

from ultraskelly.utilities.get_video_paths import get_video_paths
...
class AniposeCameraCalibrator:
    ...
    def _initialize_anipose_objects(self):
        ...
        self._anipose_camera_group_object = ultraskelly_anipose.CameraGroup.from_names(list_of_camera_names)
        ...
        self._anipose_charuco_board = ultraskelly_anipose.AniposeCharucoBoard(
    ...
    def pin_camera_zero_to_origin(self, cam_group: ultraskelly_anipose.CameraGroup):
        """
        ...
        Args:
            cam_group (ultraskelly_anipose.CameraGroup): A group of calibrated cameras whose extrinsics will be adjusted in place.
        """
    ...
    def align_rotations_to_cam0(self, cam_group: ultraskelly_anipose.CameraGroup):
    ...
    def shift_origin_to_cam0(self, cam_group: ultraskelly_anipose.CameraGroup):
    ...
    def set_charuco_board_as_groundplane(self, cam_group: ultraskelly_anipose.CameraGroup):
    ...
    def adjust_world_reference_frame_to_charuco(self,
                                                cam_group: ultraskelly_anipose.CameraGroup,
