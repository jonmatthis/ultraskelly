...
from ultraskelly.core.pipeline.pipeline_configs import CameraNodeTaskConfig, CalibrationCameraNodeConfig
from ultraskelly.core.types.type_overloads import FrameNumberInt
